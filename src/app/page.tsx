          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl">
            ...
            >
              ...
              <div className="relative w-full overflow-hidden aspect-[344/145] lg:aspect-[4/3] rounded-lg">
                <div
                  data-active="true"
                  className={`iso-stage pointer-events-none absolute -z-10 aspect-[1642/1200] max-w-none -translate-x-1/2 -translate-y-1/2 transition-transform duration-700 ease-out group-hover:scale-[1.05] ${isDark ? "text-gray-500" : "text-gray-400"}`}
