...
export default function ToolsPage() {
        ...
        <main className="px-4 py-6 sm:px-6 md:px-8 md:py-10">
            ...
            <section className="mt-8 mb-2 sm:mb-4 text-center flex flex-col items-center justify-center">
                ...
                <a href="http://lynk.id/ruangcreativemuslim/0elxm3wy387w/checkout" target="_blank"
                    ...
                    className="w-[90%] sm:w-auto inline-flex items-center justify-center bg-white px-10 py-4 rounded-full font-semibold text-[13px] sm:text-[14px] hover:bg-rn-yellow transition-all duration-300 font-heading uppercase tracking-widest whitespace-nowrap !text-black !no-underline">
    ...
    <div
        ...
        <a href="http://lynk.id/ruangcreativemuslim/0elxm3wy387w/checkout" target="_blank"
            ...
            className="w-full bg-white border border-white py-3.5 rounded-full font-semibold text-sm font-heading uppercase tracking-widest hover:bg-rn-yellow hover:border-rn-yellow transition-colors brutalist-shadow-sm flex items-center justify-center gap-2 !text-black !no-underline">
            Akses Rp 99.000
        </a>
    </div>
